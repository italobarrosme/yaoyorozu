...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-primary-regular transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-complementary-highlight data-[state=active]:text-inherit data-[state=active]:shadow-sm',
      className
    )}
    {...props}
  />
...
export const Tabs = ({
  ...
  return (
    <TabsBase defaultValue={defaultValue}>
      <TabsList className={`grid w-full grid-cols-${tabsContents.length}`}>
