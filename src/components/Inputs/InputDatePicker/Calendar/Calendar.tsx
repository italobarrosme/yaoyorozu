        ...
        <DayPicker
          ...
          classNames={{
            ...
            day: cn(
              ...
              'h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-md transition-all duration-100'
            ),
            day_range_end:
              'day-range-end rounded-r-md rounded-l-none !bg-complementary-highlight',
            day_range_start:
              'day-range-start rounded-l-md !bg-complementary-highlight rounded-r-none',
            day_selected:
